...
- `docs/PI_DEV_CHEATSHEET.md` and `docs/PI_DEV_CHEATSHEET_EN.md` are agent workflow guides — reference them when the user asks about subagent flows, review loops, or oracle patterns.
